                            ...
                            case 3:
                                {
                                    ...
                                    while(!salircombinados)
                                    {
                                        ...
                                        cout<<endl;
                                        cout<<"----------------------------------------------------------------------------"<<endl;
                                        cout<<"                            MENU DE COMBINACIONES                           "<<endl;
                                        cout<<"----------------------------------------------------------------------------"<<endl;
                                        cout<<" A - UNA EMPRESA VENDE 5 DIFERENTES TIPO DE ARTICULOS EN 3 SUCURSALES       "<<endl;
                                        cout<<" B - UNA PERSONA HA ANOTADO SUS GASTOS, DIA A DIA DURANTE TODO EL AÑO PASADO"<<endl;
                                        cout<<" C - UNA EMPRESA FABRICA 200 PRODUCTOS QUE SON VENDIDOS POR 5 VENDEDORES    "<<endl;
                                        cout<<" D - UNA FABRICA PRODUCE 70 DISTINTOS TIPOS DE ENGRANAJES EN 15 MAQUINAS    "<<endl;
                                        cout<<"----------------------------------------------------------------------------"<<endl;
                                        ...
                                        case 'b':
                                            {
                                                system("cls");
                                                int Dia_Mes_mat[31][12] = {0};
                                                Ejercicioscombinados2(Dia_Mes_mat);
                                                PuntoAcombi2(Dia_Mes_mat);
                                                cin.ignore();
                                                cin.get();
                                        ...
                                        case 'c':
                                            {
                                                system("cls");
                                                int matvendedorA[31][12] = {0};
                                                int matvendedorB[31][12] = {0};
                                                int matvendedorC[31][12] = {0};
                                                int matvendedorD[31][12] = {0};
                                                int matvendedorE[31][12] = {0};
                                                Ejercicioscombinados3(matvendedorA,matvendedorB,matvendedorC,matvendedorD,matvendedorE);
                                                PuntoAcombi3(matvendedorA,matvendedorB,matvendedorC,matvendedorD,matvendedorE);
                                                cin.ignore();
                                                cin.get();
                                            }break;
                                        case 'D':
                                        case 'd':
                                            {
                                                system("cls");
                                                int Tipoengranajemayor[70] = {0};
                                                int Numeromaquinamenor[15] = {0};
                                                Ejercicioscombinados4(Tipoengranajemayor,70,Numeromaquinamenor,15);
                                                PuntoAcombi4(Tipoengranajemayor,70);
                                                PuntoBcombi4(Numeromaquinamenor,15);
                                                cin.ignore();
                                                cin.get();
                                            }break;
                                        case 'E':
